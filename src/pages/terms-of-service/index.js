...
const PrivacyPolicy = () => (
  <Layout>
    <h2>Heather Turano Coaching LLC Terms of Service</h2>
    <h3>1. Terms</h3>
    <p>
    ...
    <ol type="a">
      ...
      <li>
        ...
        restrictions and may be terminated by Heather Turano Coaching LLC at any
    ...
    <p>
      ...
      notice. However Heather Turano Coaching LLC does not make any commitment
      to update the materials.
    </p>
    <h3>6. Links</h3>
    <p>
      Heather Turano Coaching LLC has not reviewed all of the sites linked to
